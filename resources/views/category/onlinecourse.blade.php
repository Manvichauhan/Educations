     ...
     <th>image</th>
      ...
      <th>Action</th>
        ...
        <tr>
         ...
         <td>
          <a href="{{url('category/onlinecourse/editt/'.$a->id)}}"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;
          <a href="{{url('category/onlinecourse/delete/'.$a->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a>&nbsp;
...
<form  method="post" action="{{url('category/onlinecourse/save')}}" enctype="multipart/form-data">

           @csrf
    
            Course Name:    <input class="form-control" type="text" name="title"><br>
