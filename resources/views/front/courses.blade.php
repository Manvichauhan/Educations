...
@foreach( $display as $x)
								...
								<div class="course-post">
									<div class="course-thumbnail-holder">
										<a href="{{url('course_detail/'.$x->id)}}">
												<img src="{{ url('/upload/'.$x->image) }}" style="width: 244px;">
										</a>
									</div>
									<div class="course-content-holder">
										<div class="course-content-main">
											...
											<div class="course-rating-teacher">
												...
												<a href="#" class="course-loop-teacher">Gunjan Gupta</a>
											</div>
										</div>
					...
					<div class="col-lg-4">
						<div class="sidebar">
							...
							@foreach($onlinec as $oc)
								<ul class="products-list">
									<li>
										<a href="single-course.html"><img src="{{ url('/upload/'.$oc->image) }}" style="height: 50px; width: 50px; "></a>
										<div class="list-content">
											<h3><a href="single-course.html">{{$oc->title}}</a></h3>
											<span>${{$oc->price}}</span>
